...
#'
#' @importFrom "ggplot2" "ggplot" "geom_bar" "aes" "theme_minimal" "theme"
#' "labs" "element_text"
#'
...
matchup_chart <- function(teamdata_matchup) {
  ...
  team1_statistics <- teamdata_matchup$list_data$team1_year1[,
                                                             c(16, 18, 20, 22)]
  team2_statistics <- teamdata_matchup$list_data$team2_year2[,
                                                             c(16, 18, 20, 22)]
  ...
  combined_stats_long <- tidyr::gather(combined_stats, "Statistic", 'Value',
                                       'EFG.', 'FTR', 'TOV.', 'OREB.')
